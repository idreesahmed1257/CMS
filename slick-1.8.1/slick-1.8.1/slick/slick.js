...
(function (factory) {
     ...
     Slick = (function () {
          ...
          function Slick(element, settings) {
               ...
               _.defaults = {
                    ...
                    asNavFor: null,
                    prevArrow:
                         '<button class="slick-prev" aria-label="Previous" type="button"><i class="fas fa-arrow-circle-left"></i></button>',
                    nextArrow:
                         '<button class="slick-next" aria-label="Next" type="button"><i class="fas fa-arrow-circle-right"></i></button>',
                    autoplay: false,
                    autoplaySpeed: 3000,
                    centerMode: false,
                    centerPadding: "50px",
     ...
     Slick.prototype.getSlideCount = function () {
          ...
          if (_.options.swipeToSlide === true) {
               ...
               slidesTraversed =
                    Math.abs(
                         $(swipedSlide).attr("data-slick-index") -
                              _.currentSlide
                    ) || 1;
          ...
          if (!event.target.tagName.match("TEXTAREA|INPUT|SELECT")) {
               if (event.keyCode === 37 && _.options.accessibility === true) {
                    _.changeSlide({
                         data: {
                              message:
                                   _.options.rtl === true ? "next" : "previous",
                         },
                    });
               } else if (
                    event.keyCode === 39 &&
                    ...
                    _.changeSlide({
                         data: {
                              message:
                                   _.options.rtl === true ? "previous" : "next",
                         },
                    });
               }
          }
